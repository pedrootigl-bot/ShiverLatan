...
A home **não rola a página**. É um deck de 7 slides: roda, trackpad, swipe, setas ou o menu trocam a seção com transição GSAP. O botão voltar do navegador também troca o slide.
...
| 06 | `#metodo` | Como lemos o mercado |
| 07 | `#faq` | FAQ, CTA e rodapé legal |
